...
VALUES 
  ('00000000-0000-0000-0000-000000000001', 'أحمد محمد', 'https://picsum.photos/seed/ahmed/100/100', 'مطور برمجيات من كفر الشيخ'),
...
VALUES 
  ('00000000-0000-0000-0000-000000000001', 'أجواء رائعة اليوم في كفر الشيخ! 🌞 هل من اقتراحات لأماكن خروج جديدة؟', 124, 45),
...
VALUES 
  ('00000000-0000-0000-0000-000000000001', 'مطور ويب (Frontend)', 'شركة كفراوي تك', 'كفر الشيخ - تقسيم المحافظة', 'دوام كامل', 'مطلوب مطور ويب خبرة سنتين', '8,000 - 12,000 ج.م'),
...
VALUES 
  ...
  ('00000000-0000-0000-0000-000000000002', 'طقم أنتريه خشب زان', 'طقم انتريه بحالة ممتازة', 4500, 'أثاث', 'مستعمل - جيد', 'كفر الشيخ');
